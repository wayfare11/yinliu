...
class CustomEdit(QWidget):
    ...
    def setupUi(self, Form):
        ...
        self.NumberBox.setMaximum(10000)
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.unitBox_6.setEditable(True)
        ...
        self.categoryBox_7.setEditable(True)
    ...
    def edit_start(self):
        ...
        if a_materialCode.strip() == "":
            QMessageBox.warning(None, '系统提示', '物料编码不能为空！')
        elif a_drawingCode.strip() == "":
            QMessageBox.warning(None, '系统提示', '图纸号不能为空！')
        elif a_Name.strip() == "":
            QMessageBox.warning(None, '系统提示', '名称不能为空！')
        elif a_Size.strip() == "":
            QMessageBox.warning(None, '系统提示', '规格/型号不能为空！')
        elif a_material.strip() == "":
            QMessageBox.warning(None, '系统提示', '材料不能为空！')
        elif a_Color.strip() == "":
            QMessageBox.warning(None, '系统提示', '颜色不能为空！')
        elif a_Number == None:
            QMessageBox.warning(None, '系统提示', '数量不能为空！')
        elif a_unit.strip() == "":
            QMessageBox.warning(None, '系统提示', '单位不能为空！')
        elif a_category.strip() == "":
            QMessageBox.warning(None, '系统提示', '物料类别不能为空！')
        else:
